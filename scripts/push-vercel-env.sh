...
for v in TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID MCP_SECRET CURSOR_API_KEY CURSOR_MODEL TELEGRAM_WEBHOOK_SECRET ALLOWED_CHAT_IDS PUBLIC_URL OPENAI_API_KEY CURSOR_REPO_URL CURSOR_REPO_REF SECRETARY_KB_URLS; do
  add "$v"
done
