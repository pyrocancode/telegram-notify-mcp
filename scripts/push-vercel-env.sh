...
for v in TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID MCP_SECRET CURSOR_API_KEY CURSOR_MODEL TELEGRAM_WEBHOOK_SECRET ALLOWED_CHAT_IDS PUBLIC_URL OPENAI_API_KEY OPENAI_MODEL; do
  add "$v"
done
